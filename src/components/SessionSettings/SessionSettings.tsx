  ...
  return (
    <div className="learn-settings">
      <div className="settings-group">
        <label>Modus:</label>
        <Button onClick={() => setLearnMode('classic')} label="Klassisch" primary={learnMode === 'classic'} />
        <Button onClick={() => setLearnMode('write')} label="Schreiben" primary={learnMode === 'write'} />
      </div>
      <div className="settings-group">
        <label>Richtung:</label>
        <Button onClick={() => setQueryDirection('q_to_a')} label="F → A" primary={queryDirection === 'q_to_a'} />
        <Button onClick={() => setQueryDirection('a_to_q')} label="A → F" primary={queryDirection === 'a_to_q'} />
        <Button onClick={() => setQueryDirection('mixed')} label="Gemischt" primary={queryDirection === 'mixed'} />
      </div>
